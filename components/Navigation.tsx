...
const DISCORD_URL = 'https://discord.gg/goodthinking';
      ...
      <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            title="Discord 커뮤니티"
            className="flex items-center gap-1.5 text-sm font-medium text-[var(--ink-2)] hover:text-[var(--accent)] transition-colors"
          >
